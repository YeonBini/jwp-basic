...
public class DispatcherServlet extends HttpServlet {
    ...
    private static final String DEFAULT_REDIRECT_INDEX = "redirect:";
    ...
    private void move(String viewName, HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
        if(viewName.startsWith(DEFAULT_REDIRECT_INDEX)) {
            resp.sendRedirect(viewName.substring(DEFAULT_REDIRECT_INDEX.length()));
            return;
        }
